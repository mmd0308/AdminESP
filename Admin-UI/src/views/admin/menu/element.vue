    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px">
        ...
        <el-form-item label="资源类型" prop="type">
          <el-radio-group style="padding: 10px;" v-model="form.type">
            <el-radio label="button">按钮</el-radio>
            <el-radio label="uri">链接</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="请求类型" prop="method">
          <el-select class="filter-item" v-model="form.method" placeholder="请输入资源请求类型" style="width: 100%">
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList();
      this.menuManager_btn_element_add = true // this.elements['menuManager:btn_element_add'];
      this.menuManager_btn_element_del = true // this.elements['menuManager:btn_element_del'];
      this.menuManager_btn_element_edit = true // this.elements['menuManager:btn_element_edit'];
    },
    computed: {
      ...mapGetters([
        'elements'
    ...
    methods: {
      ...
      handleCreate() {
        ...
        if (this.menuObj.code) {
          this.form.code = this.menuObj.code + ':';
        }
        this.form.uri = this.menuObj.href;
